...
function PlayerInfo() {
    ...
    if (gamesPlayed >= 65) {
        ...
        statusString = `At this pace, ${displayName} will ${gamesPlayedPace >= 65 ? "" : "not"} be eligible for postseason awards.`;
    } else {
        statusString = `${displayName} has missed too many games to be eligible for postseason awards.`
    }
